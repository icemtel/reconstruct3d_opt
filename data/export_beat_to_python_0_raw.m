...
% Save shapes
xname = sprintf('res/raw/x0-%d.dat',iframe_raw);
yname = sprintf('res/raw/y0-%d.dat',iframe_raw);
...
% Save shapes
x2name = sprintf('res/raw/x20-%d.dat',iframe_raw);
zname = sprintf('res/raw/z0-%d.dat',iframe_raw);
save(x2name,'xflag_raw','-ASCII');
save(zname,'yflag_raw','-ASCII');
end % iframe
